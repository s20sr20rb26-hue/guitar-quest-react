...
const COURSE_COPY: Record<string, { title: string; desc: string }> = {
  '邦楽ロック': { title: '邦楽ロックコース', desc: 'ライブで使いやすい王道リフとバンド曲から固める。' },
  'J-POP': { title: 'J-POP伴奏コース', desc: '歌を支えるコード、ストローク、曲展開への反応を育てる。' },
  'けいおん!': { title: 'けいおん!コース', desc: '楽しく曲数を増やしながら、バンド曲の体力を作る。' },
  'アニソン/ボカロ': { title: 'アニソン・ボカロコース', desc: '速い展開、歪み、リード気味のフレーズに慣れる。' },
  '洋楽ロック': { title: '洋楽ロックコース', desc: 'ギターらしいリフ、休符、ノリを体に入れる。' },
  'カッティング/ファンク': { title: 'グルーヴ強化コース', desc: '左手ミュートと16ビートで右手を育てる。' },
  'ブルース/R&R': { title: 'ブルース・R&Rコース', desc: 'ペンタ、チョーキング、ロックンロールのノリを磨く。' },
  'R&B/フュージョン': { title: 'R&B・フュージョンコース', desc: 'テンションコードとセッション感を育てる。' },
  '民謡': { title: '民謡アレンジコース', desc: '耳なじみのある旋律をギターで楽しむ。' },
};
